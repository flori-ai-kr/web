...
// 오프라인이면 CSS 번들이 로드되지 않을 수 있어 인라인 스타일로 자급자족하게 한다.
// prefers-color-scheme 다크 대응은 <style> 미디어쿼리로 처리.
...
.flori-offline__btn { padding: 10px 20px; border-radius: 10px; border: none; cursor: pointer;
  font-size: 14px; font-weight: 600; background-color: #A85475; color: #fff; }
...
export default function OfflinePage() {
  return (
    <div className="flori-offline">
      ...
      <button className="flori-offline__btn" onClick={() => location.reload()}>
        다시 시도
      </button>
    </div>
  );
