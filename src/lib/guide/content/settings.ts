...
export const SETTINGS_ARTICLES: GuideArticle[] = [
  {
    ...
    tldr: [
      ...
      '닉네임은 커뮤니티에서 보이는 이름이에요 (중복 확인 필요)',
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        text: '**프로필 정보** 메뉴를 누르면 가게명·닉네임·이메일·지역을 수정하고 프로필 사진을 바꿀 수 있어요.',
      },
      { type: 'shot', src: 'profile/01-overview', kind: 'png', alt: '내 프로필 화면', caption: '가게명·닉네임·이메일·지역' },
