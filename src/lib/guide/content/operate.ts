...
export const OPERATE_ARTICLES: GuideArticle[] = [
  {
    ...
    blocks: [
      ...
      { type: 'shot', src: 'sales/02-form', alt: '매출 입력 동작', caption: '+ 버튼 → 금액 → 저장까지', kind: 'gif' },
      {
        ...
        text: '**로드 구입**을 쓰면 채널(길거리)·고객 정보 없이 금액 위주로 빠르게 기록할 수 있어요. 바쁠 때 특히 편해요.',
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'shot', src: 'calendar/01-form', kind: 'png', alt: '새 예약 등록 화면', caption: '고객·결제·금액·픽업을 한 화면에서' },
      {
        type: 'callout',
        variant: 'note',
        text: '**결제일자**는 오늘로 미리 채워져 있어요. 아직 돈을 못 받았다면 결제방식을 **미수**로 두었다가, 나중에 [매출](/admin/guide/sales)에서 **결제 완료**로 정산하면 돼요.',
      },
