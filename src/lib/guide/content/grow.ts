        ...
        tabs: [
          {
            ...
            blocks: [
              ...
              { type: 'shot', src: 'insights/01-auction', kind: 'png', alt: '꽃 경매 시세 화면', caption: '품목·단가·전일 대비 변동' },
              {
                ...
                variant: 'note',
                title: '스크랩하면 알림을 받아요',
                text: '관심 품목을 **스크랩**해두면, **새 경매 시세가 들어올 때 푸시 알림**으로 알려드려요. 알림은 **설정 > 알림 수신 설정**에서 켜고 끌 수 있어요.',
              },
            ],
          },
          {
            ...
            blocks: [
              ...
              { type: 'shot', src: 'insights/02-grants', kind: 'png', alt: '지원사업 목록 화면', caption: '신청 기한·지원 기관·원문 링크' },
              {
                ...
                variant: 'note',
                title: '스크랩하면 알림을 받아요',
                text: '관심 사업을 **스크랩**해두면 **마감 하루 전(D-1)**과 **마감 당일(D-day)**에 **푸시 알림**으로 알려드려요. 알림은 **설정 > 알림 수신 설정**에서 켜고 끌 수 있어요.',
              },
            ],
          },
        ],
